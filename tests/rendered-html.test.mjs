...
test("keeps the required Slivadoc Partners content", async () => {
  ...
  assert.match(layout, /favicon-16x16\.png\?v=3/);
  assert.match(layout, /favicon-32x32\.png\?v=3/);
  assert.match(layout, /favicon-48x48\.png\?v=3/);
  assert.match(layout, /brand\/slivadoc-favicon\.png\?v=3/);
  assert.match(layout, /apple-touch-icon\.png\?v=3/);
  assert.match(layout, /mstile-150x150\.png\?v=3/);
  assert.match(layout, /manifest: "\/manifest\.webmanifest"/);
  assert.match(manifest, /slivadoc-192\.png\?v=3/);
  assert.match(manifest, /slivadoc-512\.png\?v=3/);
  assert.match(manifest, /slivadoc-maskable-192\.png\?v=3/);
  assert.match(manifest, /slivadoc-maskable-512\.png\?v=3/);
  assert.match(svgFavicon, /<title>Slivadoc<\/title>/);
  assert.match(svgFavicon, /data:image\/png;base64/);
